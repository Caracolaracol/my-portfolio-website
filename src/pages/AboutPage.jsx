...
import { PagesContainer } from '../components/utils/Containers'
    ...
    return (
        <PagesContainer>
            <div className="max-w-[45rem] showproject">
                <div className="mb-6">
                    <h1 className="card-title font-tommyregular text-lg tracking-wider">About Me.
                    </h1>
                </div>
