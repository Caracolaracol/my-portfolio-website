    ...
    return (
        <section className='flex flex-col h-screen justify-center'>
            <div className='self-center mb-16'>
                <div className='w-64 h-64 tablet:w-72 tablet:h-72 overflow-hidden flex '>
                ...
                <div className='flex flex-col justify-evenly flex-nowrap text-center mb-6 tablet:mb-2 overflow-hidden px-2'>
                    <h1 className="overflow-hidden text-[2.4rem] font-bold font-tommy antialiased tablet:tracking-wide tablet:text-4xl laptop:text-6xl laptop:tracking-normal">Caracolaracol <em className='text-naranjahover font-tommy font-black text-4xl tablet:text-3xl laptop:text-7xl'>//</em> Creative Developer</h1>
                    <p className='text-sm font-tommylight tablet:text-lg tablet:tracking-wide'># Hi there! I'm Agustín Rojas, i'm a web developer, <a className='text-naranja' href="https://open.spotify.com/album/34djgWmJuu2dNanqrupzok" target="_blank">musician</a>, <a className='text-naranja' href="https://caracolaracolracolacolcololl.blogspot.com/" target="_blank">writer</a>, photographer and motion designer based on Chile.</p>
                    <h2 className='text-2xl font-chrono antialiased tablet:text-3xl laptop:tracking-wide'>Welcome to my site!</h2>
                </div>

                <div className='flex flex-row justify-center mb-4 gap-5 ml-3 mr-3'>
                    <button className='font-tommyregular tablet:text-xl bg-purpural rounded-sm hover:bg-purpuralh hover:text-texth p-3 tablet:p-5'>
                ...
                <div  className='flex flex-col justify-center text-center'>
                    <div className='flex gap-4 '>
                        ...
                        <a className='font-chrono text-xl tablet:text-2xl' href="https://drive.google.com/file/d/1leg_c4dXK_TOjvJ2J35yD0Hf5FyeqX8f/view?usp=sharing" target="_blank">CV</a>
                    </div>
                </div>
            </div>
