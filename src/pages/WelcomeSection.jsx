...
function WelcomeSection(){
    const {enterHandler} = useContext(GeneralContext)
                ...
                <div className='self-center mb-16 overflow-hidden'>
                    ...
                    <div className='flex flex-row justify-center mb-4 gap-5 ml-3 mr-3'>
                        <Link to='/web-projects'>
                            <button onClick={enterHandler} className='font-tommyregular tablet:text-xl bg-purpural rounded-sm hover:bg-purpuralh hover:text-texth p-3 tablet:p-5'>
